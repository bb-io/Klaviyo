...
{
    [Display("Universal content ID", Description = "Universal content ID or template-universal-content::email:: translation ID. If omitted, it is read from the downloaded HTML metadata.")]
